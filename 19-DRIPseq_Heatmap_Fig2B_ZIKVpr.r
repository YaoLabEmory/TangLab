#Genome-wide significantly upregulated and downregulated sites detected by DRIP-seq in ZIKVpr-infected cells (FDR < 0.05).
#DRIP-seq: Heatmap of comparison between ZIKVpr vs Mock.
