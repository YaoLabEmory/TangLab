...
case1="U251_KO_ZV1/U251_KO_ZV1_peaks.narrowPeak"
case2="U251_KO_ZV2/U251_KO_ZV2_peaks.narrowPeak"
control1="U251_KO_Mock/U251_KO_Mock_peaks.narrowPeak"
...
write.table(case.peak,file="KO/case.peak.bed",row.names=F,col.names=F,sep="\t",quote=F)
write.table(control.peak,file="KO/control.peak.bed",row.names=F,col.names=F,sep="\t",quote=F)
...
write.table(all.peak,file="KO/all.peak.bed",row.names=F,col.names=F,sep="\t",quote=F)

case1="U251_KO_ZV1/U251_KO_ZV1.sorted.bed"
case2="U251_KO_ZV2/U251_KO_ZV2.sorted.bed"
control1="U251_KO_Mock/U251_KO_Mock.sorted.bed"
case1.gr=import(case1)
case2.gr=import(case2)
control1.gr=import(control1)
...
write.table(allmat,file="KO/DESeq.xls",sep="\t",quote=FALSE,row.names=FALSE)
